...
describe('Starting tests for angular-app', function() {
  ...
  it('network-name should be hyper-vote@0.0.1',() => {
    element(by.css('.network-name')).getWebElement()
    .then((webElement) => {
      return webElement.getText();
    })
    .then((txt) => {
      expect(txt).toBe('hyper-vote@0.0.1.bna');
    });
  });
  ...
  it('navbar-brand should be angular-app',() => {
    ...
    it('Share table should have 8 columns',() => {
      page.navigateTo('/Share');
    ...
    it('Shareholder component should be loadable',() => {
      page.navigateTo('/Shareholder');
      browser.findElement(by.id('participantName'))
      .then((participantName) => {
        return participantName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('Shareholder');
      });
    });

    it('Shareholder table should have 4 columns',() => {
      page.navigateTo('/Shareholder');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('MakeVote component should be loadable',() => {
      page.navigateTo('/MakeVote');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('MakeVote');
      });
    });
  
    it('TransferShare component should be loadable',() => {
      page.navigateTo('/TransferShare');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('TransferShare');
      });
    });
